...
import com.celada.eatshub.catalog.mapper.RestaurantMapper;
...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    @Override
    public Flux<RestaurantResponse> readByNameStartingWithIgnoreCase(String name) {
    ...
    @Override
    public Flux<RestaurantResponse> readByPriceRangeIn(List<PriceRange> prices) {
    ...
    @Override
    public Flux<RestaurantResponse> readByAddressCity(String city) {
